<form wire:submit.prevent="submit">
    <div class="overflow-hidden w-full rounded-lg shadow-xs">
        <div class="overflow-x-auto w-full space-y-5">
            ...
            <div>
                <x-input-label for="questions_file" :value="__('Ficheiro JSON com perguntas')" />
                <x-text-input type="file" wire:model="questions_file" id="questions_file" name="questions_file" class="block w-1/3" />
            </div>
    ...
    <x-primary-button class="mt-5">Submeter perguntas</x-primary-button>
</form>
