      ...
      <div className="mt-5 space-y-5">
        {currentQuestion.options.map((option) => (
          <motion.div
            ...
            className={`w-full flex items-center px-1.5 md:px-4 py-2 md:py-3 border border-gray-100 min-h-[4rem] md:min-h-[5rem] rounded hover:cursor-pointer hover:bg-primary hover:text-white transition ease-in-out ${
