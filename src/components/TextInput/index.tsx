  ...
  return (
    <div className="">
      <input
        ...
        } w-full dark:bg-primary-dark dark:text-white py-1 px-2 rounded-md shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 focus-within:text-primary-600 ${className}`}
      />
