    ...
    <div className="min-h-screen w-full text-sm md:text-md px-5 md:px-24 pb-5">
      ...
      <span className="h-full">
        <p>
          ...
          informações quando um utilizador visita o Website. Ao continuar a usar o Website, concorda
          com o uso de cookies de acordo com esta política.
        </p>
        ...
        <ul>
          <li className="mt-1 ml-2">
            - Cookies essenciais: São cookies necessários para o funcionamento adequado do Website.
            Incluem, por exemplo, cookies de autenticação.
          </li>
          <li className="mt-1 ml-2">
        ...
        <p>O Website utiliza cookies essencias de forma a garantir o seu funcionamento adequado.</p>
        ...
        <p>
          ...
          configurar o seu browser para bloquear todos os cookies ou para receber um aviso antes que
          um cookie seja armazenado. No entanto, observe que o desativar dos cookies pode afetar a
        ...
        <p>
          ...
          forma como utilizamos cookies. Recomendamos que revise esta Política regularmente para se
          manter informado sobre como usamos os cookies.
        </p>
