      ...
      <section className="grid grid-cols-2 px-6 mt-10 gap-x-4 md:grid-cols-4 gap-y-10 md:gap-x-10 md:px-16">
        {subjects.map((subject) => (
          <Link
            ...
            key={subject.id}
            className="flex flex-col items-center justify-center w-full h-full p-5 space-y-6 text-center transition ease-in-out rounded shadow dark:shadow-gray-500 md:h-48 group hover:bg-primary">
